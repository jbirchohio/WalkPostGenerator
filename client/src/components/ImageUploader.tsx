      ...
      {selectedImage ? (
        ...
        <div className="text-center py-8">
          ...
          <div className="flex justify-center mt-3 gap-3">
            ...
            <Button
              type="button"
              className="inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-cafe-brown rounded-md hover:bg-cafe-lightBrown focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-cafe-brown"
